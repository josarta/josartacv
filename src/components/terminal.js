...
export class TerminalController {
  constructor(containerId, i18nManager) {
    ...
    this.commands = {
      ...
      status: () => '[OK] Systems Operational | P99 Latency: < 12ms | High Availability: ACTIVE | Agentic Pipeline: READY',
      skills: () => '<b>AI:</b> Multi-Agent RAG, vLLM, Qdrant, PyTorch, Evaluation & Tracing, PINNs<br><b>SRE/Backend:</b> High Availability, Java/Spring, Python, C#, Kubernetes, OpenTelemetry, Prometheus, Kafka<br><b>Control:</b> Closed-loop stability, Lyapunov bounds, MPC, Embedded Telemetry',
      projects: () => 'Selected Reference Architectures:<br>1. <a href="#projects" class="text-emerald-400 hover:underline">Agentic-RAG-Engine</a> (Enterprise Multi-Agent RAG)<br>2. <a href="#projects" class="text-emerald-400 hover:underline">MLOps-Pipeline-Suite</a> (Automated Drift & K8s Canaries)<br>3. <a href="#projects" class="text-emerald-400 hover:underline">Control-AI-Optimizer</a> (PINNs & Dynamic Feedback)<br>4. <a href="#projects" class="text-emerald-400 hover:underline">Local-AI-Agent-Terminal</a> (Offline AST Coding Assistant)',
      experience: () => '<b>BBVA (2024-Pres):</b> Service Reliability Lead (High Availability & Platform Stability)<br><b>BBVA IT (2022-2026):</b> Senior Software Expert (Distributed Scientific Engines)<br><b>Mercado Libre (2021-2022):</b> Senior Software Developer (High-Volume E-Commerce)',
      architecture: () => '<b>AI in Production Pipeline:</b> Model → Context (Hybrid RAG) → Orchestration (Agents) → Evaluation (Grounding/Recall) → Observability (OTel) → Infra (K8s) → Reliability (High Availability & Resilient Loops)',
